...
Repositório de Backend: https://github.com/NovaisBrunoo/back-integral-m05-t09

Repositório de Frontend: https://github.com/NovaisBrunoo/front-integral-m05-t09/tree/Develops

URL da aplicação funcionando: https://front-integral-m05-t09-02.vercel.app/

---

E os itens abaixo, que deverão ser preenchidos apenas após a finalização de todas as sprints do projeto: 

**Pull Request (PR) de Backend** `https://vercel.com/novaisbrunoo/front-integral-m05-t09`: 

**Pull Request (PR) de Frontend** `https://dashboard.render.com/web/srv-cgure2peuhlij5056jm0`: 
